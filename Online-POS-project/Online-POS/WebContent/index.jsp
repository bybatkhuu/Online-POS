...
<html lang="mn">
  ...
  <body>
	...
	<div class="bh-print-view" style="width: 260px;">
		<div class="row">
						...
						for (int i = 0; i < itemList.size(); i++)
						{
							out.println("<div class='row'>");
	              			...
	              			out.println("<div class='row'>");
	                          	...
	                          	if (result != 0)
	                          	{
	                          		out.println("<div class='col-xs-4'>" + itemList.get(i).getQuantity() + "</div>");
	                          	}
	                          	else
	                          	{
	                          		out.println("<div class='col-xs-4'>" + (int)itemList.get(i).getQuantity() + "</div>");
	                          	}
	                          	out.println("<div class='col-xs-4'>" + format.format(itemList.get(i).getPrice()) + "</div>");
	                          	out.println("<div class='col-xs-4 text-right'>" + format.format(itemList.get(i).getTotal()) + "</div>");
	              			out.println("</div>");
